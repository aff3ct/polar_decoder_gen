#ifndef PATTERN_POLAR_TTA_SC_REP_LEFT_HPP_
#define PATTERN_POLAR_TTA_SC_REP_LEFT_HPP_
...
namespace tools
{
class Pattern_polar_TTA_SC_rep_left : public Pattern_polar_rep_left
{
protected:
	Pattern_polar_TTA_SC_rep_left(const int &N, const Binary_node<Pattern_polar_i>* node,
...
public:
	Pattern_polar_TTA_SC_rep_left(const int min_level = 2, const int max_level = -1)
	: Pattern_polar_rep_left(min_level, max_level) {}

	virtual ~Pattern_polar_TTA_SC_rep_left() {}

	virtual Pattern_polar_TTA_SC_rep_left* alloc(const int &N, const Binary_node<Pattern_polar_i>* node) const
	{
		if (node == nullptr)
			return new Pattern_polar_TTA_SC_rep_left(this->min_level, this->max_level);
		else
			return new Pattern_polar_TTA_SC_rep_left(N, node, this->min_level, this->max_level);
	}
...
#endif /* PATTERN_POLAR_TTA_SC_REP_LEFT_HPP_ */
