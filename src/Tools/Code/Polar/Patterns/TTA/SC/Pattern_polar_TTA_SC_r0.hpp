#ifndef PATTERN_POLAR_TTA_SC_RATE_0_HPP_
#define PATTERN_POLAR_TTA_SC_RATE_0_HPP_
...
namespace aff3ct
{
	namespace tools
	{
		class Pattern_polar_TTA_SC_r0 : public Pattern_polar_r0
		{
		protected:
			Pattern_polar_TTA_SC_r0(const int &N, const Binary_node<Pattern_polar_i>* node,
		...
		public:
			Pattern_polar_TTA_SC_r0(const int min_level = 0, const int max_level = -1)
					: Pattern_polar_r0(min_level, max_level) {}

			virtual ~Pattern_polar_TTA_SC_r0() {}

			virtual Pattern_polar_TTA_SC_r0* alloc(const int &N, const Binary_node<Pattern_polar_i>* node) const
			{
				if (node == nullptr)
					return new Pattern_polar_TTA_SC_r0(this->min_level, this->max_level);
				else
					return new Pattern_polar_TTA_SC_r0(N, node, this->min_level, this->max_level);
			}
...
#endif /* PATTERN_POLAR_TTA_SC_RATE_0_HPP_ */
