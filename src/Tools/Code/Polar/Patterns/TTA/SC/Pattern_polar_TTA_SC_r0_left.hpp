...
public:
	...
	virtual Pattern_polar_TTA_SC_r0_left* alloc(const int &N, const Binary_node<Pattern_polar_i>* node) const
	{
		if (node == nullptr)
			return new Pattern_polar_TTA_SC_r0_left(this->min_level, this->max_level);
		else
