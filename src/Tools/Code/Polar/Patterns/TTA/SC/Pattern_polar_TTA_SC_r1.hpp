#ifndef PATTERN_POLAR_TTA_SC_RATE_1_HPP_
#define PATTERN_POLAR_TTA_SC_RATE_1_HPP_
...
namespace tools
{
class Pattern_polar_TTA_SC_r1 : public Pattern_polar_r1
{
protected:
	Pattern_polar_TTA_SC_r1(const int &N, const Binary_node<Pattern_polar_i>* node,
...
public:
	Pattern_polar_TTA_SC_r1(const int min_level = 0, const int max_level = -1)
	: Pattern_polar_r1(min_level, max_level) {}

	virtual ~Pattern_polar_TTA_SC_r1() {}

	virtual Pattern_polar_TTA_SC_r1* alloc(const int &N, const Binary_node<Pattern_polar_i>* node) const
	{
		if (node == nullptr)
			return new Pattern_polar_TTA_SC_r1(this->min_level, this->max_level);
		else
			return new Pattern_polar_TTA_SC_r1(N, node, this->min_level, this->max_level);
	}
...
#endif /* PATTERN_POLAR_TTA_SC_RATE_1_HPP_ */
