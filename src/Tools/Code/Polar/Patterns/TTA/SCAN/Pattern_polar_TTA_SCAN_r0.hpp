#ifndef PATTERN_POLAR_TTA_SCAN_RATE_0_HPP_
#define PATTERN_POLAR_TTA_SCAN_RATE_0_HPP_
...
namespace aff3ct
{
	namespace tools
	{
		class Pattern_polar_TTA_SCAN_r0 : public Pattern_polar_r0
		{
		protected:
			Pattern_polar_TTA_SCAN_r0(const int &N, const Binary_node<Pattern_polar_i>* node,
		...
		public:
			Pattern_polar_TTA_SCAN_r0(const int min_level = 0, const int max_level = -1)
...
#endif /* PATTERN_POLAR_TTA_SCAN_RATE_0_HPP_ */
